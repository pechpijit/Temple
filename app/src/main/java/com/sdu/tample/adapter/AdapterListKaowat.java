...
public class AdapterListKaowat extends RecyclerView.Adapter<AdapterListKaowat.VersionViewHolder> {
    ArrayList<ModelTemple> posts;
    String url;
    Context context;
    OnItemClickListener clickListener;

    public AdapterListKaowat(Activity applicationContext, ArrayList<ModelTemple> posts, String url) {
    ...
    public void onBindViewHolder(final VersionViewHolder versionViewHolder, final int i) {
        ...
        try {
            Glide.with(context)
                    .load(url + "/templeImage/" +posts.get(i).getTempleImage())
